...
import {uploadImages, addRegister, agregarRegistro, getUser} from '../../Utils/Acciones';
...
export default function AddProduct() {
    ...
    const addProduct = async ()=>{
        ...
        if(isEmpty(titulo)){
            ...
            const add = await agregarRegistro("Productos", producto);

            if(add.statusResponse){
                setloading(false);
                Alert.alert("Registro exitoso", "El producto o servicio se agrego correctamente", [
                    {
                        style: "cancel",
                        text: "Entendido",
                ...
                setloading(false);
                Alert.alert("Registro Fallido", "Ha ocurrido un error al agregar el producto", [
                    {
                        style: "cancel",
                        text: "Aceptar",
                    }
    ...
    return (
        <KeyboardAwareScrollView style={styles.container}>
            ...
            <Button title="Agregar Nuevo Producto" buttonStyle={styles.btnaddnew}
                onPress={addProduct}
            />
